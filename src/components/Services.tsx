    ...
    <section id="servizi" className="py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
            {coreServices.map((service, index) => (
              <Card 
                key={index} 
                className="group hover:shadow-xl transition-all duration-300 border-0 bg-white hover:bg-gray-50 transform hover:-translate-y-2"
              >
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold font-space-grotesk text-navy-deep mb-4">
              🚀 Servizi Visivi di Potenziamento
            </h3>
            <p className="text-lg text-gray-600">
